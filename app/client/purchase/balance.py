...
def settlement_balance(
    ...
    if overwrite_amount == -1 and not ask_overwrite:
        print("Either ask_overwrite must be True or overwrite_amount must be set.")                                 return None
    ...
    settlement_payload = {
        ...
        "cc_payment_type": "",                                "is_myxl_wallet": False,
        "pin": "",
        "ewallet_promo_id": "",
        "members": [],                                        "total_fee": 0,
        "fingerprint": "",
        ...
        "additional_data": {
            ...
            "quota_bonus": 0,
            "cashtag": "",
            "is_family_plan": False,                              "combo_details": [],
            "is_switch_plan": False,
            "discount_recurring": 0,
            "is_akrab_m2m": False,
            "balance_type": "PREPAID_BALANCE",                    "has_bonus": False,
            "discount_promo": 0
        },
    ...
    body = encrypted_payload["encrypted_body"]            x_sig = get_x_signature_payment(
                api_key,
                tokens["access_token"],
                ts_to_sign,
                payment_targets,
    ...
    headers = {
        ...
        "x-hv": "v3",                                         "x-signature-time": str(sig_time_sec),
        "x-signature": x_sig,
    ...
    try:
        ...
        if decrypted_body["status"] != "SUCCESS":
            ...
            print(f"Error: {decrypted_body}")                     return decrypted_body                     
        print(f"Purchase result:\n{json.dumps(decrypted_body, indent=2)}")                                  
        return decrypted_body
    except Exception as e:                                    print("[decrypt err]", e)
