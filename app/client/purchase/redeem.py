...
def settlement_bounty(
    api_key: str,
    tokens: dict,                                         token_confirmation: str,
    ts_to_sign: int,                                      payment_target: str,
    price: int,
    item_name: str = "",
):                                                        # Settlement request
    ...
    settlement_payload = {
        ...
        "members": [],
        "total_fee": 0,
        "fingerprint": "",                                    "autobuy_threshold_setting": {
            "label": "",
            "type": "",
            "value": 0
        },
        ...
        "akrab_members": [],
        "akrab_parent_alias": "",                             "referral_unique_code": "",
        "coupon": "",                                         "payment_for": "REDEEM_VOUCHER",
        "with_upsell": False,
        "topup_number": "",
        "stage_token": "",
        ...
        "access_token": tokens["access_token"],               "wallet_number": "",
        ...
        "items": [{
            "item_code": payment_target,                          "product_type": "",
            "item_price": price,
            "item_name": item_name,
            "tax": 0
        }]                                                }
        ...
        api_key=api_key,
        method="POST",
        path=path,                                            id_token=tokens["id_token"],
...
def settlement_loyalty(
    ...
    headers = {
        ...
        "x-request-at": java_like_timestamp(x_requested_at),                                                        "x-version-app": "8.9.0",
    }
    ...
    try:
        ...
        print("[decrypt err]", e)
        return resp.text                              
def bounty_allotment(                                     api_key: str,
    tokens: dict,
    ts_to_sign: int,
    ...
    x_sig = get_x_signature_bounty_allotment(
        api_key=api_key,                                      sig_time_sec=ts_to_sign,
